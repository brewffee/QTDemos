#############################################################################
# Makefile for building: qtdemos
# Generated by qmake (3.1) (Qt 5.15.4)
# Project:  qtdemos.pro
# Template: app
# Command: /usr/bin/qmake -o Makefile qtdemos.pro
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = qtdemos1.0.0
DISTDIR = /run/media/geixcowo/Storage/db/QTDemos/.tmp/qtdemos1.0.0
LINK          = g++
...
DIST          = /usr/lib/qt/mkspecs/features/spec_pre.prf \
		...
		qtdemos.pro  main.cpp
QMAKE_TARGET  = qtdemos
DESTDIR       = 
TARGET        = qtdemos
...
Makefile: qtdemos.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/sanitize.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
